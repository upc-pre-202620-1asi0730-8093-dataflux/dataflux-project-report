...
| :--- | :---: | :--- |
| AV1 – Sprint Review | 4 | **Cisneros Salas Luis Angel:** En este Sprint 1 realicé el Needfinding del proyecto (User Personas, User Task Matrix, Big Picture EventStorming y Ubiquitous Language), la definición de los sistemas de búsqueda y navegación de la Información Architecture, el diseño UX/UI de la Web Application (Wireframes y Wireflow Diagrams), la configuración del entorno de desarrollo, y la documentación completa del Sprint 1 (Sprint Planning, matriz de liderazgo y colaboración, Sprint Backlog, evidencia de desarrollo, ejecución, servicios y despliegue).<br>**Viza Quispe Marlon Packard:**<br>**Manosalva Tovar Miroslav Oscar:**<br>**Montalvo Vásquez Bruno Rodrigo:**<br>**Vargas Manchinelli Deiby Juan:** |
| TB1 – Stage Review | 7 | |
